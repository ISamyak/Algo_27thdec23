...
folder_path = './Nirmal_Fincap/NIFTY_ADJ_OPT_2023/4/20APR23'
nifty_path = './Nirmal_Fincap/Nifty/2023/'
n_path = nifty_path + 'data1.csv'
...
with open(filepath, 'w', newline='') as file:
	...
	for i in files:
		...
		# a=getting_ohlc_nifty(output_opening_time,output_closing_time)
		a1=getting_nifty_data_from_excel(date,0,374)
		...
		while time_obj.time() < datetime.strptime('14:55:59', '%H:%M:%S').time():
			...
			if count15_C>=3 or count20_C>=3 or count30_C>=3 or count15_P>=3 or count20_P>=3 or count30_P>=3 :
				...
				if value[0] in max_values_7 or value[1] in max_values_7:
					Callable=True
				else:
					Callable=False
				...
				if value[0] in max_values_8 or value[1] in max_values_8:
					Putable=True
				else:
					Putable=False	
...
# http://mbtrk.co/DVPlY9ZaBW7xnoRCpVUUbg%3D%3D

# http://mbtrk.co/jIfaArADnefedqQes8rGCA%3D%3D

# https://www.nobroker.in/property/2-bhk-apartment-for-rent-in-sector-82a-gurgaon-for-rs-15000/8a9fd183881f81fa01881f8769540007/detail?nbFr=list-renthttps://www.nobroker.in/property/2-bhk-apartment-for-rent-in-sector-36-gurgaon-for-rs-12500/8a9fd28285921fae018592779c6321ff/detail?nbFr=list-rent

# https://www.nobroker.in/property/2-bhk-apartment-for-rent-in-sector-36-gurgaon-for-rs-12500/8a9fd28285921fae018592779c6321ff/detail?nbFr=list-rent